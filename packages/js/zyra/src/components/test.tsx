...
import { STORE_BLOCKS } from './block';
                    ...
                    >
                        ...
                        <ReactSortable
                            ...
                            setList={(newList) => {
                                ...
                                const parentField = { ...newFormFieldList[parentIndex] };
                                const updatedColumns = [...(parentField.columns || [])];

                                updatedColumns[colIndex] = newList;
                                parentField.columns = updatedColumns;
                                newFormFieldList[parentIndex] = parentField;
                        ...
                        >
                            {column.map((childField) => (
                                <div
                                    key={childField.id}
                                    className={`form-field ${opendInput?.id === childField.id ? 'active' : ''
                                        }`}
                                    onClick={(e) => {
                                        e.stopPropagation();
