                            ...
                            <ToggleSetting
                                ...
                                onChange={ ( val: string | string[] ) => {
                                    ...
                                    if ( selectedVal === 'predefined' ) {
                                        ...
                                        const value =
                                            props.predefinedOptions[ 0 ]
                                                ?.value ?? '';

                                        setSelectedPalette( value );

                                        const option =
                                            props.predefinedOptions.find(
                                                ( opt ) => opt.value === value
                                            );
                ...
                <PDFDownloadLink
                    document={
                        <ActivePdf
                            colors={ {
                                colorPrimary:
                                    customColors.colorPrimary ?? '#FF5959',
                                colorSecondary:
                                    customColors.colorSecondary ?? '#FADD3A',
                                colorAccent:
                                    customColors.colorAccent ?? '#49BEB6',
                                colorSupport:
                                    customColors.colorSupport ?? '#075F63',
                            } }
                        />
                    }
