<?php
/**
 * ProductUpdatedTrigger class file.
 *
 * @package VuloPilot
 */
...
/**
 * @class       ProductUpdatedTrigger class
 * @version     1.0.0
 * @author      MultiVendorX
 */
class ProductUpdatedTrigger extends AbstractObjectEventTrigger {
    ...
    public function get_label(): string {
        return __( 'Product updated', 'vulopilot' );
    }
