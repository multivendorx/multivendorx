			...
			content: (
                ...
                <Column grid={8}>
						...
						{!appLocalizer.khali_dabba && (
							<Card
								title={__('Build a professional marketplace', 'notifima')}
								badge={[
									{ text: 'Starting at $299/year', color: 'blue' }
								]}
								desc={__('Unlock advanced features and premium modules to create a marketplace that stands out.', 'notifima')}
							>
								<MiniCard
								...
								<div className="pro-banner">
									<div className="text">
										{__('Join 8,000+ successful marketplace owners', 'notifima')}
									</div>
									<div className="des">
										{__(
									...
									{renderUpgradeButton(__('Upgrade Now', 'notifima'))}

									<div className="des">
										{__('15-day money-back guarantee', 'notifima')}
									</div>
								</div>
							</Card>
                    ...
                    {/* Right Side */}
					<Column grid={4}>
						<Card contentHeight title={__('Extend your website', 'Notifima')}>
							<Column row>
								{pluginStatus[
                        ...
                        {/* Quick Links */}
						<Card contentHeight title={__('Need help getting started?', 'notifima')}>
							<div className="cards-wrapper quick-link">
								{resources.map((res, index) => (
									<div className="cards" key={index}>
										...
										<h3>
											{__(res.title, 'notifima')}
										</h3>
										<p>
											{__(res.desc, 'notifima')}
										</p>
									</div>
								))}
							</div>
				...
				<>
					<Column grid={8}>
						<Card
							...
							desc={__('See what you get with Notifima Pro', 'notifima')}
							action={
								<a
									href="https://notifima.com/pricing/"
									className="admin-btn btn-purple"
