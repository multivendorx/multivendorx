            ...
            content: (
                <>
                    ...
                    <Column grid={4}>
                        <Card
                            contentHeight
                            title={__('Extend your website', 'Notifima')}
                        >
                            <Column row>
                        ...
                        <Card
                            contentHeight
                            title={__('Need help getting started?', 'notifima')}
                        >
                            <div className="cards-wrapper quick-link">
                                {resources.map((res, index) => (
                                    <div className="cards" key={index}>
                                        ...
                                        <h3>{__(res.title, 'notifima')}</h3>
                                        <p>{__(res.desc, 'notifima')}</p>
                                    </div>
                                ))}
                            </div>
                        </Card>
