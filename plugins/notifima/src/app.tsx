...
const App = () => {
    ...
    document.querySelectorAll( '#toplevel_page_notifima>ul>li>a' )
        .forEach( ( menuItem ) => {
    ...
    return (
        ...
        <AdminHeader 
            ...
            free={(window as any).appLocalizer?.freeVersion}
            pro={(window as any).appLocalizer?.pro_data?.version}
            managePlanUrl={(window as any).appLocalizer?.pro_data?.manage_plan_url}
