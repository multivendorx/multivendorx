...
class Hooks {
    function __construct() {
        ...
        add_action( 'woocommerce_checkout_order_processed', array( $this, 'create_vendor_order' ), 1, 3 );
        add_action( 'woocommerce_store_api_checkout_order_processed', array( $this, 'create_vendor_order_block_support' ), 1, 1 );
    ...
    public function create_vendor_order_block_support( $order ) {
        $this->create_vendor_order( $order->get_id(), array(), $order );
    }
