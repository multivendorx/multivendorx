...
export const temp1 = {
	...
	blocks: [
		...
		},
		{
			...
			html: __(
				'<p>Thank you for registering your store with <strong>MultiVendorX Marketplace</strong>!</p><p>Please complete your store setup to start selling products and reach thousands of customers.</p>',
				'multivendorx'
			),
			style: {
				backgroundColor: '#ffffff',
