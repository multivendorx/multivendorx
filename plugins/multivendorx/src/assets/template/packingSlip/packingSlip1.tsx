				...
				<View>
					...
					>
						...
						>
							...
							<Text style={{ fontSize: 12, color: '#555' }}>
								Total Quantity:{' '}
								<Text style={{ fontWeight: 600 }}>5 Units</Text>
							</Text>
						</View>{' '}
						{/* right section end */}
					</View>
						...
						>
							...
							>
								...
								<Text style={{ fontSize: 11 }}>
									Verify all items against this packing slip
								</Text>
							</View>
							...
							>
								<RightArrowIcon color={colors.colorPrimary} />
								<Text style={{ fontSize: 11 }}>
									Check product condition before packing
								</Text>
							</View>
							...
							>
								<RightArrowIcon color={colors.colorPrimary} />
								<Text style={{ fontSize: 11 }}>
									Use appropriate packaging materials for
									fragile items
								</Text>
							</View>
							...
							>
								<RightArrowIcon color={colors.colorPrimary} />
								<Text style={{ fontSize: 11 }}>
									Include this packing slip in the package
								</Text>
							</View>
