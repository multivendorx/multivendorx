	...
	const buttonActions = [
		{
		  ...
		  onClickWithQuery: ExportCSV({
			...
			columns: (order: any) => ({
			  Order_ID: { header: __('Order ID', 'multivendorx'), value: order.id },
			  Store: { header: __('Store', 'multivendorx'), value: order.store_name || '' },
			  Amount: { header: __('Amount', 'multivendorx'), value: order.total },
			  Commission: { header: __('Commission', 'multivendorx'), value: order.commission_total || 0 },
			  Status: { header: __('Status', 'multivendorx'), value: order.status },
			  Date: { header: __('Date', 'multivendorx'), value: order.date_created },
			}),
		  }),
		},
	  ];
