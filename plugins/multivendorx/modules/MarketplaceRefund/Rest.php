...
class Rest extends \WP_REST_Controller {
    ...
    protected $rest_return_base = 'returns';
    ...
    public function add_refund_status( $schema ) {
        ...
        $schema['properties']['status']['enum'][] = 'return-requested';
        return $schema;
    }
    ...
    * @return WP_REST_Response|WP_Error
    */
    public function get_return_items( $request ) {
    ...
    public function return_update( $request ) {
