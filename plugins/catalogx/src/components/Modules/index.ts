    ...
    modules: [
        {
            ...
            settingsLink: `${appLocalizer.site_url}#&tab=settings&subtab=shopping`,
            proModule: true,
        },
        {
            id: 'enquiry',
            ...
            settingsLink: `${appLocalizer.site_url}#&tab=settings&subtab=enquiry`,
            proModule: false,
        },
        {
            id: 'quote',
            ...
            settingsLink: `${appLocalizer.site_url}#&tab=settings&subtab=quotation`,
            proModule: false,
        },
        {
            id: 'wholesale',
            ...
            settingsLink: `${appLocalizer.site_url}#&tab=settings&subtab=wholesale`,
            proModule: true,
        },
        {
            id: 'rules',
            ...
            settingsLink: `${appLocalizer.site_url}#&tab=rules`,
            proModule: true,
        },
    ],
};
